...
```bash
./scripts/test-rbac-phase1.sh  # Test role extraction
./scripts/test-rbac-phase2.sh  # Test resource ownership
./scripts/test-rbac-phase3.sh  # Test gateway headers
./scripts/test-rbac-phase4.sh  # Test ABAC policies
```
