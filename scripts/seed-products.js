 ...
 * 
 * This script:
 * 1. Generates/downloads sample product images
  ...
  products: [
    {
      ...
      price: 1299.00,
      stock: 50,
      imageKeywords: 'hoodie,navy,blue,sweatshirt',
      exclusive: true,
    },
    {
      ...
      price: 499.00,
      stock: 100,
      imageKeywords: 'tshirt,white,round-neck,cotton',
      exclusive: false,
    },
    {
      ...
      price: 299.00,
      stock: 200,
      imageKeywords: 'mug,coffee,ceramic,white',
      exclusive: false,
    },
    {
      ...
      price: 149.00,
      stock: 300,
      imageKeywords: 'stickers,laptop,vinyl,colorful',
      exclusive: false,
    },
    {
      ...
      price: 399.00,
      stock: 75,
      imageKeywords: 'cap,baseball,black,hat',
      exclusive: true,
    },
    {
      name: 'NITTE Notebook',
      ...
      price: 199.00,
      stock: 150,
      imageKeywords: 'notebook,journal,a5,lined',
      exclusive: false,
    },
    {
      ...
      price: 599.00,
      stock: 80,
      imageKeywords: 'bottle,water,steel,silver',
      exclusive: false,
    },
    {
      name: 'NITTE Hoodie - Premium Edition',
      description: 'Limited edition premium hoodie with gold embossed NITTE logo. Only available to verified alumni.',
      category: 'apparel',
      price: 2499.00,
      stock: 25,
      imageKeywords: 'hoodie,premium,gold,limited',
      exclusive: true,
    },
  ],
};
...
async function ensureBucket() {
  try {
    ...
    if (error.name === 'NotFound' || error.$metadata?.httpStatusCode === 404) {
      ...
      // Note: Bucket creation requires additional permissions
      // For now, assume bucket is created by minio-init service
...
async function seedProducts() {
  ...
  try {
    ...
    for (let i = 0; i < CONFIG.products.length; i++) {
      ...
      console.log(`[${i + 1}/${CONFIG.products.length}] Seeding: ${product.name}`);
      
      // Generate image
      const imageText = product.name.replace(/[^a-zA-Z0-9]/g, '+');
      console.log(`  → Generating image...`);
      const imageBuffer = await generatePlaceholderImage(imageText);
...
module.exports = { seedProducts, CONFIG };
